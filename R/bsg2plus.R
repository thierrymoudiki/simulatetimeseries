...
#'
#' Simulates short rate, asset price, and discount bond price using the Black-Scholes-G2++ model.
#'
#' @param n Integer. Number of simulations (default: 100).
#' @param t0 Integer. Valuation date (must be > 1, default: 1).
#' @param horizon Integer. Simulation horizon (default: 5).
#' @param K Numeric. Strike price (default: 95).
#'
#' @return A list with simulated short rate, asset price, and discount bond price.
#'
#' @examples
#' sims <- simulate_bsg2plus(t0=1, n=10L, horizon=5L)
#' str(sims)
#'
#' @export
